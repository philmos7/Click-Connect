...
target_did = 'did:plc:zd6anyawi2jnhtbmud5aab6i'
...
# Load post data
posts_df = pd.read_csv("/path/to/data/rijksmuseum_posts.csv")
...
top10_df.to_csv("C/path/to/data/rijksmuseum_top10.csv", index=False)

worst10_df = non_reposts_df.sort_values(by='engagement_score', ascending=True).head(10)
worst10_df.to_csv("/path/to/data/rijksmuseum_worst10.csv", index=False)
...
engagement_growth_df.to_csv("/path/to/data/rijksmuseum_engagement_growth.csv", index=False)
...
latest_df.to_csv("/path/to/data/rijksmuseum_posts_latest_enriched.csv", index=False)
...
print("Saved files:\n - rijksmuseum_posts_latest_enriched.csv\n - rijksmuseum_top10.csv\n - rijksmuseum_worst10.csv\n - rijksmuseum_engagement_growth.csv")
